      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/notes" class="rounded-md px-3 py-2 text-sm font-medium text-white <?php
            echo urlIs('/notes') ? 'bg-gray-900 text-white'
              : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?>" aria-current="page">Notes</a>
            <a href="/about" class="rounded-md px-3 py-2 text-sm font-medium text-white <?php
            echo urlIs('/about') ? 'bg-gray-900 text-white'
              : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?>" aria-current="page">About</a>
            <a href="/contact" class="rounded-md px-3 py-2 text-sm font-medium text-white <?php
            echo urlIs('/contact') ? 'bg-gray-900 text-white'
